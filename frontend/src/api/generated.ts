...
export type GetApiGameChatParams = {
take?: number;
};
...
export type getApiGamePlayerResponse200 = {
  data: PlayerResponse
  status: 200
}
    
export type getApiGamePlayerResponseComposite = getApiGamePlayerResponse200;
    
export type getApiGamePlayerResponse = getApiGamePlayerResponseComposite & {
  headers: Headers;
}

export const getGetApiGamePlayerUrl = () => {
...
export const getApiGamePlayer = async ( options?: RequestInit): Promise<getApiGamePlayerResponse> => {
  
  const res = await fetch(getGetApiGamePlayerUrl(),
  {      
    ...options,
    method: 'GET'
  ...
  const body = [204, 205, 304].includes(res.status) ? null : await res.text()
  const data: getApiGamePlayerResponse['data'] = body ? JSON.parse(body) : {}

  return { data, status: res.status, headers: res.headers } as getApiGamePlayerResponse
}



export const getGetApiGamePlayerQueryKey = () => {
    return [`/api/Game/player`] as const;
    }

    
export const getGetApiGamePlayerQueryOptions = <TData = Awaited<ReturnType<typeof getApiGamePlayer>>, TError = unknown>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiGamePlayer>>, TError, TData>>, fetch?: RequestInit}
) => {

const {query: queryOptions, fetch: fetchOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetApiGamePlayerQueryKey();

  

    const queryFn: QueryFunction<Awaited<ReturnType<typeof getApiGamePlayer>>> = ({ signal }) => getApiGamePlayer({ signal, ...fetchOptions });

      

      

   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getApiGamePlayer>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type GetApiGamePlayerQueryResult = NonNullable<Awaited<ReturnType<typeof getApiGamePlayer>>>
export type GetApiGamePlayerQueryError = unknown


export function useGetApiGamePlayer<TData = Awaited<ReturnType<typeof getApiGamePlayer>>, TError = unknown>(
  options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiGamePlayer>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof getApiGamePlayer>>,
          TError,
          Awaited<ReturnType<typeof getApiGamePlayer>>
        > , 'initialData'
      >, fetch?: RequestInit}
...
export function useGetApiGamePlayer<TData = Awaited<ReturnType<typeof getApiGamePlayer>>, TError = unknown>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiGamePlayer>>, TError, TData>>, fetch?: RequestInit}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
...
export function useGetApiGamePlayer<TData = Awaited<ReturnType<typeof getApiGamePlayer>>, TError = unknown>(
 ...
 , queryClient?: QueryClient 
  ...
  const queryOptions = getGetApiGamePlayerQueryOptions(options)
...
export type getApiGamePlayersOnlineResponse200 = {
  data: OnlinePlayerResponse[]
  status: 200
}
    
export type getApiGamePlayersOnlineResponseComposite = getApiGamePlayersOnlineResponse200;
    
export type getApiGamePlayersOnlineResponse = getApiGamePlayersOnlineResponseComposite & {
  headers: Headers;
}

export const getGetApiGamePlayersOnlineUrl = () => {


  

  return `/api/Game/players/online`
}

export const getApiGamePlayersOnline = async ( options?: RequestInit): Promise<getApiGamePlayersOnlineResponse> => {
  
  const res = await fetch(getGetApiGamePlayersOnlineUrl(),
  {      
    ...options,
    method: 'GET'
  ...
  const body = [204, 205, 304].includes(res.status) ? null : await res.text()
  const data: getApiGamePlayersOnlineResponse['data'] = body ? JSON.parse(body) : {}

  return { data, status: res.status, headers: res.headers } as getApiGamePlayersOnlineResponse
}



export const getGetApiGamePlayersOnlineQueryKey = () => {
    return [`/api/Game/players/online`] as const;
    }

    
export const getGetApiGamePlayersOnlineQueryOptions = <TData = Awaited<ReturnType<typeof getApiGamePlayersOnline>>, TError = unknown>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiGamePlayersOnline>>, TError, TData>>, fetch?: RequestInit}
) => {

const {query: queryOptions, fetch: fetchOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetApiGamePlayersOnlineQueryKey();

  

    const queryFn: QueryFunction<Awaited<ReturnType<typeof getApiGamePlayersOnline>>> = ({ signal }) => getApiGamePlayersOnline({ signal, ...fetchOptions });

      

      

   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getApiGamePlayersOnline>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type GetApiGamePlayersOnlineQueryResult = NonNullable<Awaited<ReturnType<typeof getApiGamePlayersOnline>>>
export type GetApiGamePlayersOnlineQueryError = unknown


export function useGetApiGamePlayersOnline<TData = Awaited<ReturnType<typeof getApiGamePlayersOnline>>, TError = unknown>(
  options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiGamePlayersOnline>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof getApiGamePlayersOnline>>,
          TError,
          Awaited<ReturnType<typeof getApiGamePlayersOnline>>
        > , 'initialData'
      >, fetch?: RequestInit}
...
export function useGetApiGamePlayersOnline<TData = Awaited<ReturnType<typeof getApiGamePlayersOnline>>, TError = unknown>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiGamePlayersOnline>>, TError, TData>>, fetch?: RequestInit}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
...
export function useGetApiGamePlayersOnline<TData = Awaited<ReturnType<typeof getApiGamePlayersOnline>>, TError = unknown>(
 ...
 , queryClient?: QueryClient 
  ...
  const queryOptions = getGetApiGamePlayersOnlineQueryOptions(options)
...
export type getApiGameChatResponse200 = {
  data: GameChatResponse[]
  status: 200
}
    
export type getApiGameChatResponseComposite = getApiGameChatResponse200;
    
export type getApiGameChatResponse = getApiGameChatResponseComposite & {
  headers: Headers;
}

export const getGetApiGameChatUrl = (params?: GetApiGameChatParams,) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0 ? `/api/Game/chat?${stringifiedParams}` : `/api/Game/chat`
}

export const getApiGameChat = async (params?: GetApiGameChatParams, options?: RequestInit): Promise<getApiGameChatResponse> => {
  
  const res = await fetch(getGetApiGameChatUrl(params),
  {      
    ...options,
    method: 'GET'
  ...
  const body = [204, 205, 304].includes(res.status) ? null : await res.text()
  const data: getApiGameChatResponse['data'] = body ? JSON.parse(body) : {}

  return { data, status: res.status, headers: res.headers } as getApiGameChatResponse
}



export const getGetApiGameChatQueryKey = (params?: GetApiGameChatParams,) => {
    return [`/api/Game/chat`, ...(params ? [params]: [])] as const;
    }

    
export const getGetApiGameChatQueryOptions = <TData = Awaited<ReturnType<typeof getApiGameChat>>, TError = unknown>(params?: GetApiGameChatParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiGameChat>>, TError, TData>>, fetch?: RequestInit}
) => {

const {query: queryOptions, fetch: fetchOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetApiGameChatQueryKey(params);

  

    const queryFn: QueryFunction<Awaited<ReturnType<typeof getApiGameChat>>> = ({ signal }) => getApiGameChat(params, { signal, ...fetchOptions });

      

      

   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getApiGameChat>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type GetApiGameChatQueryResult = NonNullable<Awaited<ReturnType<typeof getApiGameChat>>>
export type GetApiGameChatQueryError = unknown


export function useGetApiGameChat<TData = Awaited<ReturnType<typeof getApiGameChat>>, TError = unknown>(
 params: undefined |  GetApiGameChatParams, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiGameChat>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof getApiGameChat>>,
          TError,
          Awaited<ReturnType<typeof getApiGameChat>>
        > , 'initialData'
      >, fetch?: RequestInit}
...
export function useGetApiGameChat<TData = Awaited<ReturnType<typeof getApiGameChat>>, TError = unknown>(
 params?: GetApiGameChatParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiGameChat>>, TError, TData>> & Pick<
        UndefinedInitialDataOptions<
          Awaited<ReturnType<typeof getApiGameChat>>,
          TError,
          Awaited<ReturnType<typeof getApiGameChat>>
...
export function useGetApiGameChat<TData = Awaited<ReturnType<typeof getApiGameChat>>, TError = unknown>(
 params?: GetApiGameChatParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiGameChat>>, TError, TData>>, fetch?: RequestInit}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
...
export function useGetApiGameChat<TData = Awaited<ReturnType<typeof getApiGameChat>>, TError = unknown>(
 ...
 , queryClient?: QueryClient 
  ...
  const queryOptions = getGetApiGameChatQueryOptions(params,options)
